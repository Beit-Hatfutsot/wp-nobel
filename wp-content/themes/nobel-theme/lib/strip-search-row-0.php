			...
			<div class="section-results-by-taxomony clearfix" data-moreresultstext="<?php the_field('moreresultstext','option'); ?>">
				...
				if($loop->have_posts()) :
					while($loop->have_posts()) : $loop->the_post();
						...
						$terms = get_the_terms($loop->id, 'winning_category');
						$terms1 = get_the_terms($loop->id, 'winning_country');
						$terms2 = get_the_terms($loop->id, 'winning_year');
						...
						data-winning_category_name="<?php echo $terms[0]->name; ?>" 
						data-winning_category_slug="<?php echo $terms[0]->slug; ?>" 
						data-winning_country_name='<?php echo $terms1[0]->name; ?>' 
						data-winning_country_slug='<?php echo $terms1[0]->slug; ?>' 
						data-winning_year_name='<?php echo $terms2[0]->name; ?>' 
						data-winning_year_slug='<?php echo $terms2[0]->slug; ?>' 
						...
						<h5><?php the_title(); ?></h5>
						<div><?php echo $terms[0]->name; ?>, <?php echo $terms2[0]->name; ?></div>
