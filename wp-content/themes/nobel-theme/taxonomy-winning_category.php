	...
	<?php endif; ?>
		...
		<div class="persona-categories clearfix">
			<div class="persona-category">
				<?php the_field('pre_category','option'); ?>
				<?php
				global $post;
				$terms = get_the_terms($post->id, 'winning_category');
				?>
				<a id="taxonomy-winning-category" class="category-box" data-category_term_id="<?php echo $terms[0]->term_id; ?>"><?php echo $terms[0]->name; ?></a>
			</div>
		</div>
		<?php get_template_part('lib/strip','search-row-01'); ?>
		</div>
